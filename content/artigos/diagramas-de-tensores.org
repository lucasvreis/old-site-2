...
#+include: "content/artigos/org-imports/diagramas-de-tensores-preamble.org"

Esse foi o segundo (e último) trabalho da disciplina de Álgebra Linear Avançada,
novamente pensei que seria interessante postar aqui. +Por enquanto, ainda não+
+consegui adaptar totalmente o tikz e a parte de referências para o modelo de+
+site, então recomendo fortemente ler em PDF.+ Já consegui ajeitar tudo com a
nova plataforma do site, a versão abaixo está totalmente de acordo com o PDF.
...
diagramas de fios sobre outra categoria (@baez2011).
...
esses diagramas é o /ZX-cálculo/, que incorpora as flexibilidades dos
...
quânticos @kissinger2020, por exemplo.

bibliography:content/artigos/org-imports/diagramas-de-tensores.bib
